...
export class CouponService {
  ...
  ManualValidate(code: string): Observable<ValidaCouponEsitoDto> {
    return this.http.post<ValidaCouponEsitoDto>(this.constants.BasePath() + '/Coupon/Manual-Validate', {code});
  }
